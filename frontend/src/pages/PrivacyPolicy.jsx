        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeInUp} className="max-w-3xl">
            ...
            <p className="text-lg text-gray-500 leading-relaxed max-w-3xl">
              Aiqda is committed to protecting user privacy and handling personal data in accordance with the Saudi Personal Data Protection Law (PDPL) and applicable regulations issued by SDAIA.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="px-8 py-6 border-b border-gray-100 bg-gray-50/80">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{privacyPolicyMeta.effectiveDate}</p>
                </div>
              </div>
            </div>
            ...
            <div className="px-8 py-10 space-y-10">
              ...
              <div className="rounded-3xl border border-primary-100 bg-primary-50/60 px-6 py-5">
                <p className="text-sm text-gray-600 leading-7">
                  For questions about this policy or to exercise your rights, please contact us through the
                  official Aiqda support channels or use the <Link to="/contact-us" className="text-primary-600 font-medium hover:text-primary-700">Contact Us</Link> page.
                </p>
              </div>
            </div>
          </div>
