        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeInUp} className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6">
              ...
              <span className="text-sm text-gray-600">Terms & Conditions For Users</span>
            </div>
            ...
            <p className="text-lg text-gray-500 leading-relaxed max-w-3xl">
              These terms govern how subscribers and account holders use Aiqda as a digital content library, including account use, content access, payments, refunds, and permitted usage rights.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="px-8 py-6 border-b border-gray-100 bg-gray-50/80">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{userTermsMeta.effectiveDate}</p>
                </div>
              </div>
            </div>
