    ...
    <div className="min-h-screen py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-dark-400 mb-8">Manage platform users</p>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-dark-700">
                      ...
                      <th className="text-left py-4 px-4 text-dark-400 font-medium">Email</th>
                      ...
                      <th className="text-left py-4 px-4 text-dark-400 font-medium">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {users.map((user) => (
                      <tr key={user._id} className="border-b border-dark-800">
                        ...
                        <td className="py-4 px-4">
                          <select
                            ...
                            className="bg-dark-800 border border-dark-700 rounded-lg px-3 py-1 text-white text-sm"
                          >
