...
router.get('/lesson/:lessonId', requirePlatformNoticeAcknowledgement, quizzesController.getQuizForStudent);
...
router.post('/lesson/:lessonId/submit', requirePlatformNoticeAcknowledgement, quizzesController.submitQuiz);
