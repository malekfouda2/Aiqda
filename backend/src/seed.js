  ...
  await Consultation.create([
    {
      ...
      focusPointsAr: ['تقييم سريع', 'توجيه في مسار التحريك (ثنائي/ثلاثي الأبعاد/هجين)', 'ملاحظات مختصرة', 'خطوات عملية تالية', 'ملخص اختياري'],
    ...
    },
    {
      ...
      focusPointsAr: ['مراجعة تفصيلية للمشروع', 'مراجعة المواد', 'خطة لنقاط القوة والضعف', 'إرشاد حول الأدوات وسير العمل', 'ملخص PDF قصير'],
    ...
    },
    {
      ...
      focusPointsAr: ['مراجعة شاملة', 'تقييم الفريق والجدول الزمني', 'تقييم الميزانية والتسويق', 'حلول إبداعية وتقنية', 'توجيه استراتيجي', 'تقرير PDF تفصيلي كامل'],
    ...
    },
    {
      ...
      focusPointsAr: ['مقدمة وأهداف التعاون', 'نظرة عامة على النطاق: أعمال 24 Center والملف الإبداعي للشريك', 'الخطوات التالية واجتماع المتابعة'],
